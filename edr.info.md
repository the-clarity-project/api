...
* **per_page** - кількість результатів на одній сторінці. За замовчуванням - 25, приймаються значення в діапазоні від 1 до 100;
...
* **edr_data** - інформація з ЄДР (якщо доступна):
    ...
    * **founders** - переліки засновників;
    * **beneficiaries** - перелфік кінцевих бенефіціарних власників
        * **Name** - ПІБ;
        * **Country** - країна громадянства;
        * **Address** - адреса;
        * **Details** - детальна інформація про вплив:
            * **type** - Тип бенефіцарного володіння
...
* **property_struct_info** - інформація про структуру власності з ЄДР;
  * **struct_signed** - відмітка, що структуру власності підписано;
  * **date_struct**, **num_struct** - дата та номер структури власності;
  * **last_name_sign**, **first_middle_name_sign** - прізвище, ім'я та по-батькові особи, яка підписала структуру власності;
  * **type_sign** - тип особи, яка підписала структуру власності:
    * **1** – керівник
    * **2** – представник
    * **3** – засновник (учасник)
    * **4** – інша уповноважена особа
    * **5** – керівник іноземної ЮО
  * **struct_false** - ознака, що можлива недостовірність структури власності
  * **struct_opaque** - ознака, що структура власності визнана Національним банком України непрозорою
  * **struct_excluded** - ознака, що відомості про структуру власності виключено за вказівкою Міністерства юстиції України
* **beneficiaries_info** - інформація про причину відсутність КБВ;
  * **excluded** - ознака, що відомості про КБВ виключено за вказівкою Міністерства юстиції України;
  * **is_missing** - ознака, що КБВ відсутній;
  * **reason** - причина відсутності КБВ;
